            ...
            @foreach($images as $image)
                <div class="profile-card">
                    ...
                    <div class="profile-info">
                        ...
                        <form class="card-body" action="{{ route('user.volunteer.account.update_photo', $user) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            ...
                            <div class="form-buttons">
                                ...
                                <div class="label-ed">
                                    ...
                                    <a id="back-button" href="{{ route('user.volunteer.view_account') }}">Повернутись</a>
                                </div>
                            </div>
                        </form>
                    </div>
