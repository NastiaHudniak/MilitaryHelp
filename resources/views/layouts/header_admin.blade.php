...
<header class="header-admin">
    <div class="header-l-c">
        <div class="header-left">
            <a class="logos" href="{{ url('/admin/home') }}">
    ...
    <div class="header-right">
        <form class="login-button" id="logout-form" method="POST" action="{{ route('logout') }}">
            @csrf
            <button type="submit" style="border: none; background-color: transparent; color: var(--white-my)">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        logoutForm.addEventListener('submit', function (e) {
            const confirmed = confirm("Ви дійсно бажаєте вийти з акаунта?");
            if (!confirmed) {
