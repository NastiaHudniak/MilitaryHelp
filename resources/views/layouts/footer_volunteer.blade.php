    ...
    <div class="row">
        ...
        <div class="col-lg-4 col-md-6 mb-4">
            ...
            <div class="list" style="color: var(--yellow-200)" >
                <a style="color: var(--yellow-200)" href="{{ route('user.volunteer.confirm.view_confirm_app') }}" >Переглянути прийняті заявки</a>
                <a style="color: var(--yellow-200)" href="{{ route('user.volunteer.view_app') }}" >Переглянути заявки</a>
                <a style="color: var(--yellow-200)" href="{{ route('user.volunteer.mil.view_military') }}" >Переглянути список волонтерів</a>
            </div>
        </div>
