...
@section('content')
    <div class="main-content" style="font-family: 'Open Sans', sans-serif;">
        <div class="card">
            ...
            <form class="card-body" action="{{ route('admin.applications.store') }}" method="POST">
                @csrf
                <div class="form-group">
                    <label class="label" for="title">Назва</label>
                    <div class="input-group">
                        <input type="text" class="form-input" id="title" name="title" value="{{ old('title') }}" placeholder="Введіть назву" >
                    </div>
                    @error('title')
                ...
                <div class="form-group">
                    <label class="label" for="category_id">Статус</label>
                    <div class="input-group">
                        <select class="form-input" id="status" name="status" placeholder="Оберіть статус" >
                ...
                <div class="form-group">
                    ...
                    <div class="input-group">
                       <input type="text" class="form-input" id="comment" name="comment" value="немає" readonly >
                    </div>
                    @error('comment')
                    <div class="text-danger">{{ $message }}</div>
                    @enderror
